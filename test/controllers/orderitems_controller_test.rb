...
class OrderitemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create orderitem" do
    assert_difference('Orderitem.count') do
      post orderitems_url, params: { orderitem: { item: @orderitem.item, note: @orderitem.note, quantity: @orderitem.quantity, status: @orderitem.status, total: @orderitem.total, user: @orderitem.user } }
    end
  ...
  test "should update orderitem" do
    patch orderitem_url(@orderitem), params: { orderitem: { item: @orderitem.item, note: @orderitem.note, quantity: @orderitem.quantity, status: @orderitem.status, total: @orderitem.total, user: @orderitem.user } }
